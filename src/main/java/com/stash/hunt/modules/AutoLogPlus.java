...
public class AutoLogPlus extends Module
{
    ...
    private void onTick(TickEvent.Post event)
    {
        ...
        if (logPosition.get())
        {
            double distanceToTarget = mc.player.getEntityPos().multiply(1,0,1).distanceTo(Vec3d.ofCenter(new BlockPos(positionX.get(), positionY.get(), positionZ.get())).multiply(1,0,1));
