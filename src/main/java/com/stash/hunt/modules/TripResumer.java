...
public class TripResumer extends Module
{
    ...
    private void classifyAndScheduleIfReady()
    {
        ...
        String ip = mc.getCurrentServer() != null ? mc.getCurrentServer().ip : "";
    ...
    private SavedTrip captureTrip()
    {
        ...
        {
            IBaritone baritone = BaritoneAPI.getProvider().getPrimaryBaritone();
            String origin = mc.getCurrentServer() != null ? mc.getCurrentServer().ip : "unknown";
            ...
            return SavedTrip.gxz(origin, dimension, false, mc.player.blockPosition().getX(), mc.player.blockPosition().getZ());
        }
        catch (Throwable t)
        {
            return null;
